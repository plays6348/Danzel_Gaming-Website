                ...
                <div className="container z-9">
                    <div className="row">
                        <div className="col-lg-6 offset-lg-3 text-center">
                            <div className="subtitle fadeInUp mb-3" data-aos="fade-up" data-aos-duration="600">Pricing Plans</div>
                            <h2 className="fadeInUp mb20" data-aos="fade-up" data-aos-duration="600">Choose plan for you</h2>                       
                        ...
                        <div className="col-xl-4 col-md-6 mb-sm-30 fadeInRight" data-aos="fade-left" data-aos-duration="600" data-aos-delay="100" >
                        ...
                        <div className="col-xl-4 col-md-6 mb-sm-30 fadeInRight" data-aos="fade-left" data-aos-duration="600"data-aos-delay="300" >
                        ...
                        <div className="col-xl-4 col-md-6 mb-sm-30 fadeInRight" data-aos="fade-left" data-aos-duration="600" data-aos-delay="500">
                            <div className={`de_pricing-table type-2 ${otherElementClassName}`}>
                                <div className="d-head mb-1">
                                </div>
