...
import image1 from '../../public/img/icons/4.png';
            ...
            <div className="row g-4">
                <div className="col-lg-4 col-md-6">
                    <div className="de-box-cat h-100">
                        ...
                        <Link href="#"><h3>Thunder and City <span>(12)</span></h3></Link>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="de-box-cat h-100">
                        <i className="fa fa-folder-open-o"></i>
                        <Link href="#"><h3>Mystic Racing Z <span>(19)</span></h3></Link>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="de-box-cat h-100">
                        <i className="fa fa-folder-open-o"></i>
                        <Link href="#"><h3>Silent Wrath <span>(17)</span></h3></Link>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="de-box-cat h-100">
                        <i className="fa fa-folder-open-o"></i>
                        <Link href="#"><h3>Funk Dungeon <span>(18)</span></h3></Link>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="de-box-cat h-100">
                        <i className="fa fa-folder-open-o"></i>
                        <Link href="#"><h3>Galactic Odyssey <span>(17)</span></h3></Link>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="de-box-cat h-100">
                        <i className="fa fa-folder-open-o"></i>
                        <Link href="#"><h3>Warfare Legends <span>(21)</span></h3></Link>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="de-box-cat h-100">
                        <i className="fa fa-folder-open-o"></i>
                        <Link href="#"><h3>Race Revolution <span>(17)</span></h3></Link>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="de-box-cat h-100">
                        <i className="fa fa-folder-open-o"></i>
                        <Link href="#"><h3>Cyber Nexus <span>(19)</span></h3></Link>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="de-box-cat h-100">
                        <i className="fa fa-folder-open-o"></i>
                        <Link href="#"><h3>Ancient Realms <span>(25)</span></h3></Link>
                    ...
                    <div className="padding40 rounded-10 box-long">
                        <div className="row align-items-center">
                            <div className="col-lg-1">
                                <Image src={image1} alt="" className="img-responsive"/>
                            </div>
