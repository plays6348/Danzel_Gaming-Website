...
import image1 from"../../public/img/misc/world-map-2.webp";
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    <h2 className="fadeInUp mb20" data-aos="fade-up" data-aos-duration="900" data-aos-delay="0">25 servers available worldwide for your game.</h2>
                </div>
                <div className="col-lg-6">
                ...
                <div className="col-lg-12 fadeInUp" data-aos="fade-up" data-aos-duration="600" data-aos-delay="600">
