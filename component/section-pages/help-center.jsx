        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-6 offset-lg-3 text-center">                            
                    <div className="subtitle  mb-3" data-aos="fade-up">Do you have</div>
                    <h2 className=" mb20" data-aos="fade-up">Any questions?</h2>
                </div>
                ...
                <div className="col-lg-6">
                    ...
                    <div className="accordion accordion-flush" id="accflush" data-aos="fade-up">
